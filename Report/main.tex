...
Toàn bộ mã nguồn, nhật ký huấn luyện (training logs) và video kết quả mô phỏng của đồ án đã được công khai và lưu trữ để phục vụ mục đích kiểm chứng. Chi tiết truy cập tại các đường dẫn dưới đây:

\subsection{Project 1: Grid World Environment}
\begin{itemize}
    \item \textbf{Phương pháp:} Q-Learning (Cổ điển)
    \item \textbf{Mô tả:} Cài đặt thuật toán Q-Learning cơ bản để giải quyết bài toán tìm đường trong mê cung Grid World.
    \item \textbf{Mã nguồn (GitHub):} \\
    \href{https://github.com/HeroKeyboardUT/Grid-World-Q-Learning}{\textcolor{blue}{https://github.com/HeroKeyboardUT/Grid-World-Q-Learning}}
\end{itemize}

\subsection{Project 2: BipedalWalker-v3 (Continuous Control)}

\begin{enumerate}
    \item \textbf{Phiên bản Baseline (Raw PPO)}
    \begin{itemize}
        \item \textbf{Notebook \& Kết quả:} \href{https://www.kaggle.com/code/phmquanghiu/doantonghop1}{\textcolor{blue}{Kaggle Report - Raw PPO Implementation}}
    \end{itemize}
    
    \item \textbf{Phiên bản có điều chỉnh (Modified PPO)}
    \begin{itemize}
        \item \textbf{Notebook \& Kết quả:} \href{https://www.kaggle.com/code/phmquanghiu/doantonghop}{\textcolor{blue}{Kaggle Report - Modified PPO Implementation}}
    \end{itemize}
\end{enumerate}
